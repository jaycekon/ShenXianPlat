<%@ page import="com.Shop.beans.Product" %>
    ...
    <div class="mainBody container-fluid">
        ...
        <div class="row">
            ...
            <div class="content col-md-10">
                ...
                <div class="tab">
                    <a href="<%=request.getContextPath()%>/BackStage/ListProduct"><button class="btn">所有商品</button></a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <%
                            List<Product> goods =(List<Product>)request.getAttribute("products");
                        ...
                        <tr>
                            ...
                            <td><%=good.getNum()%></td>
                            <td><a href="<%=request.getContextPath()%>/BackStage/deleteProduct?id=<%=good.getId()%>" class="table_a">删除</a></td>
                        </tr>
                        <%
                            }
                        %>
