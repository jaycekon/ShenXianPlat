...
require(['jquery', 'juicer', 'bootstrap'], function($, juicer, bootstrap) {
	...
	//热门商品区域
	var goods = [{
		imgSrc: 'app/page/index/img/5.png'
	}, {
		imgSrc: 'app/page/index/img/2.png'
	}, {
		imgSrc: 'app/page/index/img/3.png'
	}, {
		imgSrc: 'app/page/index/img/4.png'
	}];
...
//				显示顶部和尾部区域
		$("#top").load("app/components/header/top.html");
